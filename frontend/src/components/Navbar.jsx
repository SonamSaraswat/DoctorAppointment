                ...
                ?<div className='flex items-center gap-2 cursor-pointer group relative'>
                    ...
                    <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                        <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                            <p onClick={()=>navigate('my-profile')} className='hover:text-white hover:bg-black cursor-pointer'>MY Profile</p>
                            <p onClick={()=>navigate('my-appointments')} className='hover:text-white hover:bg-black cursor-pointer'>MY Appointment</p>
                            <p onClick={()=>SetToken(false)} className='hover:text-white hover:bg-black cursor-pointer'>LogOut</p>
                        </div>
                    </div>
